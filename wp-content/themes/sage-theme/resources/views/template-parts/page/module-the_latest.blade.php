            ...
            <div class="flex flex-row flex-wrap w-full">
                <div class="left xx:w-1/2 xx:ml-48 lg:w-full 2xl:w-57-per lg:-ml-1 md:ml-13 md:w-93-per p-4 ">
                    <div class="bg-white rounded-4xl shadow-2xl">
                        <div class="rounded-t-4xl w-full lg:h-293 2xl:h-270 xx:h-262 md:h-295 bg-no-repeat bg-cover" style="background-image:url({{$data->module['image']->url}})" ></div>
                        <!-- <img class="rounded-t-3xl" src="@asset('/images/May-27.jpg')"> -->
                        <div class="2xl:p-15 lg:p-20 md:p-15">
                            <div class="font-bold">
                                {!! $data->module['contentl'] !!}
                            </div>
